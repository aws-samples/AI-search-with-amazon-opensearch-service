...
def run(api_key: str, session_id: str, prompt: str) -> Tuple[str, str]:
    ...
    # OPENAI_API_KEY = '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'
    ...
    openSearch_ = OpenSearchVectorSearch(index_name=DOMAIN_INDEX,
    ...
    llm=llm,
    chain_type="stuff",
    retriever=openSearch_.as_retriever(),
    memory = memory
    )
