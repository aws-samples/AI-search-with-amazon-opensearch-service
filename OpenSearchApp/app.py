...
if(playground):
    st.switch_page('pages/Semantic_Search.py')
with c4:
    multimodal_disabled = st.session_state.play_disabled or st.session_state.BEDROCK_MULTIMODAL_MODEL_ID == ""
    rag_playground = st.button('RAG playground', type = 'primary', disabled = multimodal_disabled)
